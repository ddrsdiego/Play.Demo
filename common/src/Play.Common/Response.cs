namespace Play.Common
{
    ...
    public readonly struct Response
    {
        ...
        private static bool IsSuccessStatusCode(int statusCode) => statusCode is < 200 or > 299;
        ...
        public static Response Ok(int statusCode) =>
            new(string.Empty, statusCode, new ResponseContent(), new ErrorResponse(), default);
        ...
        public static Response Ok(int statusCode, string requestId) =>
            new(requestId, statusCode, new ResponseContent(), new ErrorResponse(), default);
        ...
        public static Response Ok(int statusCode, string requestId, long elapsedTime) =>
            new(requestId, statusCode, new ResponseContent(), new ErrorResponse(), elapsedTime);
